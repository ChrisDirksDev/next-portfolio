  ...
  const skills = [
    {
      ...
      title: "Curiosity",
      description: "I embrace challenges with an explorer’s mindset, always eager to learn, adapt, and uncover the best solutions for every project.",
    },
    {
      icon: <FaHandshake className="w-12 h-12" />,
      title: "Collaboration",
      description: "Great ideas come to life through teamwork. I thrive on building strong connections, sharing knowledge, and creating innovative results together.",
    },
    {
      icon: <FaCrosshairs className="w-12 h-12" />,
      title: "Precision",
      description: "Details matter. I take pride in crafting clean, efficient, and reliable code that brings visions to life and exceeds expectations.",
    },
  ];
  ...
  const projects = [
    {
      ...
      description: 'A full-stack eCommerce example built with Vite + React, Tailwind, and Zustand on the frontend, alongside an Express backend with a hosted MongoDB database.',
  ...
  return (
    <div className="container mx-auto flex flex-col justify-center items-center">
      ...
      <section className="container mx-auto flex flex-col md:flex-row items-center gap-8 py-16">
        <motion.div className="w-full md:w-1/3 flex justify-center" {...fadeUpAttr} >
          <Image
            src="/me.png" // Replace with actual image path
            alt="Your Name"
            width={1000}
            height={1000}
        ...
        <div className="w-full md:w-2/3">
          <motion.h2 className="font-heading mb-4" {...fadeUpAttr}>Behind the Screen</motion.h2>
      ...
      <section className="container mx-auto py-16">
        <motion.h2 className="text-center mb-12" {...fadeUpAttr}>Skills</motion.h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          {skills.map((skill, index) => (
            <motion.div key={index} className="flex flex-col items-center" {...fadeUpAttr}>
              {skill.icon}
      ...
      <section id="projects" className="py-16">
        <motion.h2 className="mb-8" {...fadeUpAttr}>My Projects</motion.h2>
